layui.use(["element", "layer", "okTab", "okMenu", "okUtils", "okLayer"], function () {
     ...
     * 生成左侧菜单树
     */
    okMenu.generatorMenu("/rwx/admin/data/menu.json", "get");
    ...
    $(".layui-footer button.donate").click(function () {
        layer.tab({
            ...
            tab: [{
                title: "支付宝",
                content: "<img src='/rwx/admin/imgs/zfb.jpg' width='200' height='300' style='margin-left: 60px'>"
            }, {
                title: "微信",
                content: "<img src='/rwx/admin/imgs/wx.jpg' width='200' height='300' style='margin-left: 60px'>"
            }]
        });
    });
    ...
    $(".layui-footer button.communication").click(function () {
        layer.tab({
            ...
            tab: [{
                title: "QQ群",
                content: "<img src='/rwx/admin/imgs/qq.png' width='200' height='300' style='display: block;margin: 0 auto'>"
            }]
        });
    });
    ...
    $("#logout").click(function () {
        okLayer.confirm("确定要退出吗？", function (index) {
            window.location = "/rwx/index.html";
        });
    });
